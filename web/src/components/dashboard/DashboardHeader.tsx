      ...
      <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-4">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-2">
          {SERIES_KEYS.map((key) => (
            ...
            >
              ...
              {/* A rule, matching the prototype — the round dots belong to the
                  ...
                  series and the checkbox states whether it is shown. */}
              <span
                aria-hidden
          ...
          <button
            ...
            className={[
              "inline-flex min-h-11 cursor-pointer items-center gap-2 rounded-full px-5 text-sm font-semibold",
              "transition-colors duration-150",
              compareMode
                ? "bg-accent text-on-accent"
                : "border border-amber-400 text-text hover:bg-amber-50 dark:hover:bg-amber-400/10",
            ].join(" ")}
          >
